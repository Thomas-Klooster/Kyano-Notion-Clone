...
.thumbs-up {
    border: #24A1C7 1px solid;
    background: #24A1C7;
}

.thumbs-down {
    border: #284e5a 1px solid;
    background: #284e5a;
}
...
.feedback-input:focus {
    border-color: #24A1C7;
    box-shadow: 0 0 0 3px rgba(36, 161, 199, 0.12);
}
...
.preview-cover {
    ...
    border-radius: 26px;
    background: #24A1C7;
    background: linear-gradient(280deg, rgba(36, 161, 199, 1) 0%, rgba(0, 22, 61, 1) 100%);
    margin-bottom: 20px;
}
