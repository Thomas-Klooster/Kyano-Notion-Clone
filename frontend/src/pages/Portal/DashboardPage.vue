            ...
            <div v-if="expandedWorkspaces.includes(workspace.id)" class="tree-children">
              <div v-for="category in workspace.categories" :key="category.slug" class="tree-group">
                <div class="tree-row tree-row-category">
                  <router-link :to="categoryRoute(category)" class="tree-row-main u-min-w-0 tree-link">
                    <div class="tree-icon icon-box">
                ...
                <div v-if="expandedCategories.includes(category.slug)" class="tree-children">
                  <div v-for="project in category.projects" :key="project.id" class="tree-group">
                    <div class="tree-row tree-row-project">
                      ...
                      <button class="tree-toggle" type="button" @click="toggleProject(project.slug)">
                        <v-icon size="18">
                    ...
                    <div v-if="expandedProjects.includes(project.slug)" class="tree-children tree-children-articles">
                      <router-link v-for="article in project.articles" :key="article.id" :to="articleRoute(article)"
